...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_163(false), "13339681512@163.com", "SRMNZESJMTOGUSPO");
    }
    ...
    public static void sendRegisterVerifyCode(String verifyCode,String targetEmailAddr)throws Exception{
        EmailSender.subject("xxxxxxxx")
                .from("xxxx")
                .text("你的邮箱验证码是："+verifyCode+"。\n有效期为10分钟，若非本人操作请忽略此信息！")
                .to(targetEmailAddr)
                .send();
    }
}
