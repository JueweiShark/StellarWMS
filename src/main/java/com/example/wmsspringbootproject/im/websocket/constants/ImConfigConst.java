package com.example.wmsspringbootproject.im.websocket.constants;
...
public class ImConfigConst {
     ...
     * 群组的验证用户的id 默认是-1
     */
    public static final int GROUP_DEFAULT_VERIFY_USER_ID = -1;

    /**
     * redis 过期时间
     */
    public static final int REDIS_EXPIRE_TIME = 60 * 60 * 72;
     ...
     * 协议名字
     */
    public static final String PROTOCOL_NAME = "protocol_wms";
     ...
     * 监听端口
     */
    public static final int SERVER_PORT = 9427;
     ...
     * 是否是申请类的消息
     */
    public static final boolean is_apply_true=true;
    public static final boolean is_apply_false=false;
    /**
     * 是否审核通过
     */
    public static final boolean is_pass_true=true;
    public static final boolean is_pass_false=false;

    /**
     * 消息的审核状态
     */
    public static final int VERIFY_STATUS_WAIT=-1;
    public static final int VERIFY_STATUS_PASS=0;
    public static final int VERIFY_STATUS_NOT=1;
}
