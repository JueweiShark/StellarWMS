...
public enum ResultCode implements IResultCode, Serializable {
    ...
    GOODS_DATA_NOT_EXIST("D0001", "商品数据不存在"),

    USER_DATA_NOT_EXIST("D0005","用户不存在"),
    CLASSIFY_DATA_NOT_EXIST("D0002", "分类数据不存在"),

    DELETE_OPERATION_FIELD("P0001", "删除操作进行失败"),
    UPDATE_OPERATION_FIELD("P0002", "更新操作进行失败"),

    INSERT_OPERATION_FIELD("P0003","插入操作进行失败"),

    QUERY_OPERATION_FIELD("P0004","查询操作进行失败"),
    IMAGE_TYPE_ERROR("P0005","图片格式不支持"),
    USER_UPLOAD_FILE_EXIST("P0006","文件已存在"),
    IMAGE_UPLOAD_ERROR("P0007","图片上传失败"),

    IMAGE_UPLOAD_SUCCESS("P0008","图片上传成功"),
    IMAGE_DELETE_SUCCESS("P0009","图片删除成功"),
    IMAGE_NOT_EXIST("P0010","图片不存在");
